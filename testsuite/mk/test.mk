...
HAVE_VANILLA := $(shell if [ -f "$(subst \,/,$(GHC_PRIM_LIBDIR))/GHC/Types.hi" ]; then echo YES; else echo NO; fi)
HAVE_DYNAMIC := $(shell if [ -f "$(subst \,/,$(GHC_PRIM_LIBDIR))/GHC/Types.dyn_hi" ]; then echo YES; else echo NO; fi)
HAVE_PROFILING := $(shell if [ -f "$(subst \,/,$(GHC_PRIM_LIBDIR))/GHC/Types.p_hi" ]; then echo YES; else echo NO; fi)
