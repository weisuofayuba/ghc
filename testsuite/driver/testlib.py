...
def do_test(name: TestName,
    ...
    if opts.pre_cmd:
        exit_code = runCmd(override_options(opts.pre_cmd),
...
def simple_run(name: TestName, way: WayName, prog: str, extra_run_opts: str) -> Any:
    ...
    # run the command
    exit_code = runCmd(cmd, stdin_arg, stdout_arg, stderr_arg, opts.run_timeout_multiplier, working_dir=opts.testdir)
