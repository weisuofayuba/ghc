...
expectVisPats :: forall pass. UnXRec pass => [LMatchPat pass] -> [LPat pass]
expectVisPats [] = []
expectVisPats (x : xs) =
  case unXRec @pass x of
    VisPat _ pat -> pat : expectVisPats xs
    _            -> panic "expectVisPats: the list of patterns should have invisible ones here"
-- ---------------------------------------------------------------------
